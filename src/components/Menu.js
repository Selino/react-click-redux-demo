      ...
      <LinkContainer exact to='/counter' active='false'>
        <Card className='card-override'>
          ...
          <Card.Body>
            ...
            <Card.Text>
              It took a while to wrap my head around exactly how Redux works and
              why it's handy on larger projects. It was helpful to learn by
              implemting on a simple component. I've also integrated Firebase
      ...
      <LinkContainer exact to='/wordcounter' active='false'>
        <Card className='card-override'>
          ...
          <Card.Body>
            ...
            <Card.Text>
              I was given a white board test and I didn't have the algorithm for
              this function committed to memory. It was the only question I was
              given during a React test. I have it memorized now!
            </Card.Text>
          </Card.Body>
        </Card>
      </LinkContainer>
